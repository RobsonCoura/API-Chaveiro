...
namespace SisChaveiro
{
    public partial class ExcluirFuncionario : Form
    {
        ...
        {
            codigo_funcionario = Convert.ToInt32(data1.Rows[e.RowIndex].Cells[1].Value);
            btnExcluir.Enabled = true;
        }

        private void SelecioneFuncionario2(object sender, DataGridViewCellEventArgs e)
        {
            Nome = Convert.ToString(data2.Rows[e.RowIndex].Cells[1].Value);
            btnExcluir.Enabled = true;
        }
