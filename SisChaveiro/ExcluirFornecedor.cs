...
namespace SisChaveiro
{
    public partial class ExcluirFornecedor : Form
    {
        ...
        {
            codigo_fornecedor = Convert.ToInt32(data1.Rows[e.RowIndex].Cells[1].Value);
            btnExcluir.Enabled = true;
        }
        private void SelecioneFornecedor2(object sender, DataGridViewCellEventArgs e)
        {
            nome_fornecedor = Convert.ToString(data2.Rows[e.RowIndex].Cells[1].Value);
            btnExcluir.Enabled = true;
        }
