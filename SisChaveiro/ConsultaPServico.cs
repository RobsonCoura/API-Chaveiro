    ...
    public partial class ConsultaPServico : Form
    {
        ...
        private void rbtnTudo_CheckedChanged(object sender, EventArgs e)
        {
            string selecionar1 = @"SELECT Id_Pedidoserv, Id_Servico, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ";

            string selecionar2 = @"SELECT Id_Pedidoservcf, Id_Servico, Id_Clientef, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CPF, Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ";
        ...
        private void txtServico_TextChanged(object sender, EventArgs e)
        {
            ...
            string selecionar1 = @"SELECT Id_Pedidoserv, Id_Servico, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ WHERE Servico LIKE '%" + servico + "%'";

            string selecionar2 = @"SELECT Id_Pedidoservcf, Id_Servico, Id_Clientef, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CPF, Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ WHERE Servico LIKE '%" + servico + "%'";
        ...
        private void txtLS_TextChanged(object sender, EventArgs e)
        {
            ...
            string selecionar1 = @"SELECT Id_Pedidoserv, Id_Servico, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ WHERE Lugar_Servico like '%" + ls + "%'";

            string selecionar2 = @"SELECT Id_Pedidoservcf, Id_Servico, Id_Clientef, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CPF, Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ WHERE Lugar_Servico like '%" + ls + "%'";
        ...
        private void txtNF_TextChanged(object sender, EventArgs e)
        {
            ...
            string selecionar1 = @"SELECT Id_Pedidoserv, Id_Servico, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ WHERE Nome_Funcionario LIKE '%" + nf + "%'";

            string selecionar2 = @"SELECT Id_Pedidoservcf, Id_Servico, Id_Clientef, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CPF, Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusao FROM PEDIDOSERVCJ WHERE Nome_Funcionario LIKE '%" + nf + "%'";
