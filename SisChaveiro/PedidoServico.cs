                ...
                (mtxtDP.Text != "") && (mtxtDC.Text != "") && (txtIDS.Text != ""))
            {
                try
                {
                    if (rbtnCNPJ.Checked == true)
                    {
                        ...
                        string inserir = @"INSERT INTO PEDIDOSERV (Id_Servico, Id_Clientej, Id_Funcionario, Nome_Cliente,
                    Nome_Funcionario, CNPJ, Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusão) VALUES
                    ...
                    Nome_Funcionario, Servico, Lugar_Servico, Preco, Data_Pedido, Data_Conclusão) VALUES
