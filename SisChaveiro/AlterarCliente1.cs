    ...
    public partial class AlterarCliente1 : Form
    {
        ...
        private void SelecioneCliente(object sender, DataGridViewCellEventArgs e)
        {
            if (selecao == 1)
            {
                ...
                idef = Convert.ToInt32(data1.Rows[e.RowIndex].Cells[0].Value);
                Cpf = Convert.ToString(data1.Rows[e.RowIndex].Cells[1].Value);
                rua = Convert.ToString(data1.Rows[e.RowIndex].Cells[2].Value);
                numero = Convert.ToInt32(data1.Rows[e.RowIndex].Cells[3].Value);
                cep = Convert.ToString(data1.Rows[e.RowIndex].Cells[4].Value);
                complemento = Convert.ToString(data1.Rows[e.RowIndex].Cells[5].Value);
                bairro = Convert.ToString(data1.Rows[e.RowIndex].Cells[6].Value);
                cidade = Convert.ToString(data1.Rows[e.RowIndex].Cells[7].Value);
                estado = Convert.ToString(data1.Rows[e.RowIndex].Cells[8].Value);
            ...
            else if (selecao == 2)
            {
                ...
                idej = Convert.ToInt32(data1.Rows[e.RowIndex].Cells[0].Value);
                Cnpj = Convert.ToString(data1.Rows[e.RowIndex].Cells[1].Value);
                rua = Convert.ToString(data1.Rows[e.RowIndex].Cells[2].Value);
                numero = Convert.ToInt32(data1.Rows[e.RowIndex].Cells[3].Value);
                cep = Convert.ToString(data1.Rows[e.RowIndex].Cells[4].Value);
                complemento = Convert.ToString(data1.Rows[e.RowIndex].Cells[5].Value);
