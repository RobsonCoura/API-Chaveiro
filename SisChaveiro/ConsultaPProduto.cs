...
namespace SisChaveiro
{
    public partial class ConsultaPProduto : Form
    {
        ...
        private void txtModelo_TextChanged(object sender, EventArgs e)
        {
            ...
            string selecionar1 = @"SELECT Id_Pedidoprod, Id_Produto, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                Modelo, Quantidade, Preco_Unico, Preco_Total, Data FROM PEDIDOPROD WHERE Modelo = '%" + modelo + "%'";

            string selecionar2 = @"SELECT Id_Pedidoprodcf, Id_Produto, Id_Clientef, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CPF, Modelo, Quantidade, Preco_Unico, Preco_Total, Data FROM PEDIDOPRODCF WHERE Modelo = '%" + modelo + "%'";

            string selecionar3 = @"SELECT Id_Pedidoprodcj, Id_Produto, Id_Clientej, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CNPJ, Modelo, Quantidade, Preco_Unico, Preco_Total, Data FROM PEDIDOPRODCJ WHERE Modelo = '%" + modelo + "%'";
        ...
        private void txtNF_TextChanged(object sender, EventArgs e)
        {
            ...
            string selecionar1 = @"SELECT Id_Pedidoprod, Id_Produto, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                Modelo, Quantidade, Preco_Unico, Preco_Total, Data FROM PEDIDOPROD WHERE Nome_Funcionario = '%" + nf + "%'";

            string selecionar2 = @"SELECT Id_Pedidoprodcf, Id_Produto, Id_Clientef, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CPF, Modelo, Quantidade, Preco_Unico, Preco_Total, Data FROM PEDIDOPRODCF WHERE Nome_Funcionario = '%" + nf + "%'";

            string selecionar3 = @"SELECT Id_Pedidoprodcj, Id_Produto, Id_Clientej, Id_Funcionario, Nome_Cliente, Nome_Funcionario,
                CNPJ, Modelo, Quantidade, Preco_Unico, Preco_Total, Data FROM PEDIDOPRODCJ WHERE Nome_Funcionario = '%" + nf + "%'";
